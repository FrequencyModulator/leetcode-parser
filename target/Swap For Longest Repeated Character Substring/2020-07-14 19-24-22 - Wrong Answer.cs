...
Runtime: N/A
Memory: N/A
URL: http://leetcode.com/submissions/detail/366698623/
Submission DateTime: July 14, 2020 7:24:22 PM
*/
   ...
   public int MaxRepOpt1(string text) 
   {
            ...
            {                
                ...
                if(charCounts.Count > 1) // new char is another
                {
                    ...
                    max = Math.Max(max, righ - left + (isSwapped ? 0 : 1)); 
            }
