...
Runtime: 264 ms
Memory: 34.8 MB
URL: http://leetcode.com/submissions/detail/473142205/
Submission DateTime: March 27, 2021 3:51:57 PM
*/
public class Solution {
    ...
    private int Comparer((int inx, string s) log1, (int inx, string s) log2)
    {
      ...
      // digit is always greate then string 
      if(isDigit1 && !isDigit2) 
        return 1; 
      else if(!isDigit1 && isDigit2) 
        return -1;
      else // if both are digit log - then order by indexes to maintain original order
