...
Runtime: 44 ms
Memory: 15.4 MB
URL: http://leetcode.com/submissions/detail/499589934/
Submission DateTime: May 28, 2021 5:03:35 PM
*/
public class Solution {
    public int Divide(int dividend, int divisor) {
      ...
      {        
        ...
        int powOfTwo = 1;
        int tmp = divisor;
        while(tmp >= HALF_INT_MIN && tmp + tmp >= dividend) // >=  because dividend and divisor are always negative
        {
          tmp += tmp; 
          powOfTwo += powOfTwo;
        }
