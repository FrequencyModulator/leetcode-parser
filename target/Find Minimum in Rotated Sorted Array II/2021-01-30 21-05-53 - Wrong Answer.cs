...
Runtime: N/A
Memory: N/A
URL: http://leetcode.com/submissions/detail/449916910/
Submission DateTime: January 30, 2021 9:05:53 PM
*/
public class Solution {
    public int FindMin(int[] nums) {
        ...
        int mid = 0;             
        if(left == right || nums[left] < nums[right]) // if array is sorted return 0 element 
          return nums[0];
        while(left < right)
        {                              
