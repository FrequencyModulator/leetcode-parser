...
Runtime: N/A
Memory: N/A
URL: http://leetcode.com/submissions/detail/377499001/
Submission DateTime: August 7, 2020 12:28:17 PM
*/
/**
...
public class Solution {
    ...
    {            
        ...
        var res = traversed
            .GroupBy(o => o.order)
            .Select(g => (vals: g.Select(i => i.TreeNode.val).ToList(), order: g.Key))
            .OrderBy(g => g.order)
            .Select(g => 
            {
                g.vals.Sort();
                return (IList<int>)g.vals;
            })                
            .ToList();
