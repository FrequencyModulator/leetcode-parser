...
Runtime: N/A
Memory: N/A
URL: http://leetcode.com/submissions/detail/377526594/
Submission DateTime: August 7, 2020 1:49:39 PM
*/
/**
...
public class Solution {
    ...
    {            
        ...
        var res = traversed
            .GroupBy(o => o.order)
            .Select(g => (vals: g.Select(i => i.TreeNode.val).OrderBy(v => v).ToList(), order: g.Key))
            .OrderBy(g => g.order)
            .Select(g => (IList<int>)g.vals)
            .ToList();
