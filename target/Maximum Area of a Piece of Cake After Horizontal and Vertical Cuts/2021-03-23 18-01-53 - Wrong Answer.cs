...
Runtime: N/A
Memory: N/A
URL: http://leetcode.com/submissions/detail/471601312/
Submission DateTime: March 23, 2021 6:01:53 PM
*/
public class Solution {
    ...
    private BigInteger MaxCutSize2(int edge, int[] cuts)
    {
      ...
      foreach(int c in cuts.Concat(new[]{edge}))
      {
        ...
        if(maxSize.e - maxSize.s < cutSize.e - cutSize.s || (maxSize.e - maxSize.s == cutSize.e - cutSize.s && maxSize.s < cutSize.s))
            maxSize = cutSize;
      }
